...
HLS_SOURCES = ../../../test.cpp ../../../alarma_mam.cpp
...
$(ObjDir)/alarma_mam.o: ../../../alarma_mam.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../alarma_mam.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/alarma_mam.d
