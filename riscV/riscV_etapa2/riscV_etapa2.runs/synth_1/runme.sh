...
HD_PWD='E:/acs_cn2/riscV/riscV_etapa2/riscV_etapa2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RISC_V_IF_ID.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RISC_V_IF_ID.tcl
